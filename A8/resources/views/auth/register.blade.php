          ...
          <div class="card-body">
            <div class="text-center">
              <a href="{{route('home')}}" tabindex="1">
                <img src="{{ asset('img/logo2.png') }}" class="register-logo my-3 " width="100" alt="Grow Logo">
              </a>
              ...
              <div>
                <form method="POST" action="{{ route('signup') }}" class="">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="inputUsername" class="form-control" value="{{ old('name') }}"
                      required>
                    @if ($errors->has('name'))
                    <span class="error">
                      {{ $errors->first('name') }}
                ...
                <a href="{{url('/googleOAuth')}}" class="text-white btn btn-lg btn-block btn-dark"><i
                  class="fa fa-google mr-2"></i> Sign in with Google</a>
              </div>
            </div>
          </div>
        </div>
