        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="">
                        <div class="px-5 ">
                            <form method="POST" action="{{route('deleteAccount') }}" onsubmit=" return confirm('Are you sure you want to delete your account? This action is permanent') && confirm('Are you really sure?');">
                                {{ csrf_field() }}
